...
*** Test Cases ***
Servis Alanı Kısıtlamaları [KT_CN_004]
    [Documentation]    Çalıştırılacak testin adı ve ID değeri "KT_CN_004" olacak.
