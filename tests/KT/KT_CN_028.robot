...
Usage Monitoring Control (kullanım izleme yönetimi) [KT_CN_028]
    [Documentation]    Çalıştırılacak testin adı ve ID değeri "KT_CN_028" olacak.
